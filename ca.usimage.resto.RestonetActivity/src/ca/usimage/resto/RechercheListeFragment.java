...
public class RechercheListeFragment extends ListFragment implements LoaderManager.LoaderCallbacks<Cursor>  {
	private ListItemSelectListener listeSelectListener;
	private String query;
	@Override
	public void onAttach(Activity activity) {
		super.onAttach(activity);
		Log.e ("onAttach", "RechercheListeFragment Attached ");
...
public void onResume()
{
	...
	public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
		Log.e("recherche", "cursor about to be swapped");
